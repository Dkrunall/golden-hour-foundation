      ...
      <div className="container max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center mb-6">
            ...
            <h3 className="font-heading text-2xl sm:text-3xl font-bold text-gray-900">Professional Training</h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h4 className="font-heading text-xl sm:text-2xl font-bold text-gray-900 mb-2">PAN India</h4>
            <p className="font-body text-sm sm:text-base text-gray-600">Coverage across all states and regions</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="font-heading text-xl sm:text-2xl font-bold text-gray-900 mb-2">Certified</h4>
            <p className="font-body text-sm sm:text-base text-gray-600">Official certificates for all candidates</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="font-heading text-xl sm:text-2xl font-bold text-gray-900 mb-2">Customized</h4>
            <p className="font-body text-sm sm:text-base text-gray-600">Course structure per requirements</p>
          </motion.div>
        </div>
      </div>
    </section>
