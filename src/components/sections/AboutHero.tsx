...
export function AboutHero() {
  ...
  const images = ['/aboutsec.jpeg', '/1.jpeg', '/new/n1.jpeg', '/new/n5.jpeg'];
    ...
    <section className="relative h-[600px] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative w-full h-full overflow-hidden">
          {images.map((image, index) => (
            ...
            >
              <Image
                src={image}
                alt={`About Us Background ${index + 1}`}
                fill
      ...
      <div className="container relative z-40">
        ...
        >
          ...
          >
            Building safer communities through comprehensive first aid training
          </motion.p>
        </motion.div>
      </div>
